// reader/IOSDevice.jsx — iPhone bezel for desktop portfolio preview only.
...
function IOSStatusBar({ time = '9:41' }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1, height: 22,
        display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: 1.5,
      }}>
        <span style={{
      ...
      <div style={{
        ...
        gap: 7, paddingTop: 1, paddingRight: 1,
      }}>
